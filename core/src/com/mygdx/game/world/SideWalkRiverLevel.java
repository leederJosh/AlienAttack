...
import com.mygdx.game.tiles.SideWalkTiles;
...
public class SideWalkRiverLevel extends AbstractLevel {
    ...
    public SideWalkRiverLevel() {
        super();
        System.out.print(AssetHandler.getAssetHandler().loadLevel("SidewalkRiverTiles/SidewalkRiver.tmx").toString());
    ...
    public TileInterface getTileByid(int layer, float x, float y) {
        ...
        return this.getTileByCoordinate(layer, (int) (x/ SideWalkTiles.TILE_SIZE), (int) (y/ SideWalkTiles.TILE_SIZE));
    }
    ...
    public TileInterface getTileByCoordinate(int layer, int col, int row){
        ...
        if (cell!= null) {
            ...
            if(tile != null) {
                int id = tile.getId();
                return SideWalkTiles.getTileByid(id);
            }
        }
        return null;
    }
    ...
    public boolean doesRectCollideWithMap(float x, float y, int width, int height){
        ...
        for(int row = (int) (y / SideWalkTiles.TILE_SIZE); row < Math.ceil((y + height) / SideWalkTiles.TILE_SIZE); row++) {
            for(int col = (int) (x / SideWalkTiles.TILE_SIZE); col < Math.ceil((x + width) / SideWalkTiles.TILE_SIZE); col++) {
